...
with stats_container:
    ...
    multi_select = st.multiselect('Which start station would you like to see?', start_station_list, key='start_station',
    ...
    slider_input = st.slider('How long should the trip be?', int(data['tripduration'].min() / 3600),
                             int(data['tripduration'].max() / 3600), 25)
